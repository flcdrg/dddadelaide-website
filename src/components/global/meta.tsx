...
const Meta: StatelessComponent<MetaArgs> = ({
  ...
  <Fragment>
    <Head>
      ...
      <meta property="og:image" content="https://dddadelaide.com/static/images/logo-og.png?v=2" />
      <meta property="twitter:image" content="https://dddadelaide.com/static/images/logo-og.png?v=2" />
